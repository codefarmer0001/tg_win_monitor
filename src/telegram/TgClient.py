...
class TgClient:
    ...
    def __init__(self, phone_number, session_path) -> None:
    ...
    async def login(self):
        self.client = TelegramClient(self.session_path, CONFIG.APP_ID, CONFIG.API_HASH, device_model='Android', system_version='10', app_version='1.0.0')
    ...
    async def run(self):
        # await TelegramClient.run_until_disconnected(clients)
        # print(22222)
        # print(self.client)
        if self.client:
            await self.client.run_until_disconnected()
